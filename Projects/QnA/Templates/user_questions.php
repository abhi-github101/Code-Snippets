...
$rs=mysqli_query($con,"select qid,title,details,status,attachment,views,post_date from questions_table order by CONVERT(SUBSTR(qid,2),SIGNED INTEGER) desc limit ".$start_limit.",".$fetchRows." ;");
