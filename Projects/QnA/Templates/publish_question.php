...
<meta charset="utf-8">
<title>QnA- Publish Question</title>
...
<div class="boxedtitle page-title"><h2>Publish Question</h2></div>
<p>Publish any question by just providing its title, details, tags. You can select tag from the list and even provide your own. You can give multiple tags to your question in custom tags field. </p>
<div class="form-style form-style-3" id="question-submit">
<form action="post_question.php" method="POST" enctype="multipart/form-data">
<div class="form-inputs clearfix">
<p>
<label class="required">Question Title<span>*</span></label>
<input name="question_title" type="text" id="question-title">
<span class="form-description">Please choose an appropriate title for the question, so other can answer it easily.</span>
</p>
<p>
...
<span class="form-description" >Please choose one primary tag, so your question can be searched easily.</span>
</p>
<p>
<label class="required">Custom Tags<span></span></label>
<input type="text" class="input" name="question_custom_tags" id="question_tags" data-seperator=",">
<span class="form-description">Choose suitable Keywords Ex: computer, programming. Use comma (,) to separate two tags.</span>
</p>
<label>Attachment</label>
<div class="fileinputs">
<input type="file" class="file" accept="image/*" id="file_input1" name="attach_file">
<div class="fakefile">
<button type="button" id="attach_file1" class="button small margin_0">No file selected</button>
<span><i class="icon-arrow-up"></i>Browse</span>
</div>
<div style="margin-top:5px;float:left;color:#848991;font-size:12px">Select .jpg, .png or .jpeg file of upto 3MB size.</div>
</div>
<div id="showAttachment" style="margin-left:136px"></div>
<script type="text/javascript">
function remove(){
