...
<!-- Form -->   
  ...
  <form action="post_answer.php" method="post" enctype="multipart/form-data" id="pri_form1" class="comment-form">
...
<input name="" type="button" id="" value="Post your Answer" class="button small color" onclick="submitAns()">
</p>
